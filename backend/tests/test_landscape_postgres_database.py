...
class LandscapePostgreSQLInitializationTests(unittest.TestCase):
    def test_initialize_requires_latest_v4_scope_migration(self) -> None:
        ...
        with self.assertRaisesRegex(
            PostgreSQLPersistenceError, "094_landscape_v4_direction_classification"
        ):
            database.initialize()
        self.assertIn("094_landscape_v4_direction_classification", queries[0])
