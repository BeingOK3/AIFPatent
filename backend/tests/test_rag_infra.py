...
class RagInfrastructureTests(unittest.TestCase):
    ...
    def test_up_builds_only_publicly_configured_images_before_no_build_compose_start(self) -> None:
        ...
        self.assertIn("085_landscape_v4_scope_limitations.sql", migrate)
        self.assertIn("086_landscape_v4_company_memory_actions.sql", migrate)
        self.assertIn("087_landscape_v4_runs.sql", migrate)
        self.assertIn("088_landscape_v4_query_plans.sql", migrate)
        self.assertIn("089_landscape_v4_search_pages.sql", migrate)
        self.assertIn("090_landscape_v4_publications.sql", migrate)
        self.assertIn("091_landscape_v4_scale_gate.sql", migrate)
        self.assertIn("092_landscape_v4_abstract_evidence.sql", migrate)
        self.assertIn("093_landscape_v4_tasks.sql", migrate)
        self.assertIn("094_landscape_v4_direction_classification.sql", migrate)
        self.assertIn("095_landscape_v4_others.sql", migrate)
        self.assertIn("096_landscape_v4_metrics_trends.sql", migrate)
        self.assertIn("097_landscape_v4_workflow_state.sql", migrate)
        self.assertIn("098_landscape_v4_analysis_units.sql", migrate)
        self.assertIn("099_landscape_v4_organizations.sql", migrate)
        self.assertIn("100_landscape_v4_patent_snapshots.sql", migrate)
        self.assertIn("101_landscape_v4_reports.sql", migrate)
